...
export default function SingelGroup() {
  ...
  const createEventClicker = (e) => {
    history(`/groups/${group.id}/events/new`);
  };

  const updateGroupClicker = (e) => {
    history(`/groups/${group.id}/edit`);
  };
  ...
  return (
    <div className="singleGroup-main">
      <div className="singleGroup-top-half">
        <div className="singleGroup-breadCrumb">
          {"<"}
        ...
        <div className="singleGroup-top-half-main">
          <div className="singleGroup-top-half-left">
            <img
              className="singleGroup-top-half-left-img"
          ...
          <div className="singleGroup-top-half-right">
            ...
            <div className="singleGroup-top-half-right-button-holder">
              {user && user.id !== group.organizerId && (
                <button
                  onClick={singelGroupClicker}
                  className="singleGroup-join-group-button"
                >
                  Join this group
                </button>
              )}
              {user && user.id === group.organizerId && (
                <div className="singleGroup-button-holder">
                  {" "}
                  <button onClick={createEventClicker}>
                    Create Event
                  </button>{" "}
                  <button onClick={updateGroupClicker}>Update</button>{" "}
                  <OpenModalButton
                    buttonText="Delete"

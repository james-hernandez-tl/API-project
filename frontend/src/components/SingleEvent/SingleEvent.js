  ...
  return (
    <div className="singleEvent-main">
      <div className="singleEvent-header">
        ...
        <h2>{event.name}</h2>
        <div className="singleEvent-header-organizer">
          Hosted by{" "}
      ...
      <div className="singleEvent-content">
        <div className="singleEvent-content-top-half">
          <div className="SingleEvent-content-main-img-holder">
            <img
              className="singleEvent-deatail-img"
          ...
          <div className="singleEvent-content-top-half-right">
            <div
              className="singleEvent-content-top-half-right-top"
              onClick={eventGroupClciker}
            >
              <div>
                <img
                  className="singleEvent-detail-group-img"
                  src={
                    groupPrevImg ? prevImg : "https://i.imgur.com/2EGj2Rk.jpeg"
                  }
                  alt=""
                />
              </div>
            ...
            <div className="singleEvent-content-top-half-right-bottom">
              <div>
                <div className="singleEvent-content-top-half-right-bottom-Icon-holders">
              ...
              <div>
                ...
                <div className="singleEvent-button-holder">
                  <div>{event.type}</div>{" "}
                  <div>
                    {user && user.id === group.organizerId && (
                      <button className="singleEvent-button">Update</button>
                    )}
                  </div>
                  <div className="singleEvent-delete-pop-up-modal">
                    {user && user.id === group.organizerId && (
                      <OpenModalButton
                        buttonText="Delete"
                        modalComponent={
                          <DeleteEvent groupId={group.id} eventId={eventId} />
                        }
                      />
                    )}
                  </div>{" "}
